...
CREATE TABLE IF NOT EXISTS `tc_action_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表' AUTO_INCREMENT=1315 ;

--
-- 转存表中的数据 `tc_action_log`
--

INSERT INTO `tc_action_log` (`id`, `member_id`, `username`, `ip`, `name`, `describe`, `url`, `status`, `update_time`, `create_time`) VALUES
(1311, 1, 'admin', '127.0.0.1', '登录', '登录操作，username：admin', '/admin.php/login/loginhandle.html', 1, 1578706483, 1578706483),
(1312, 1, 'admin', '127.0.0.1', '登录', '登录操作，username：admin', '/admin.php/login/loginhandle.html', 1, 1578707615, 1578707615),
(1313, 1, 'admin', '127.0.0.1', '登录', '登录操作，username：admin', '/admin.php/login/loginhandle.html', 1, 1580530875, 1580530875),
(1314, 1, 'admin', '127.0.0.1', '新增', '友情链接新增，name：1213', '/admin.php/blogroll/blogrolladd.html', 1, 1580540100, 1580540100);
...
CREATE TABLE IF NOT EXISTS `tc_addon` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
INSERT INTO `tc_addon` (`id`, `name`, `title`, `describe`, `config`, `author`, `version`, `status`, `create_time`, `update_time`) VALUES
...
CREATE TABLE IF NOT EXISTS `tc_api` (
...
INSERT INTO `tc_api` (`id`, `name`, `group_id`, `request_type`, `api_url`, `describe`, `describe_text`, `is_request_data`, `request_data`, `response_data`, `is_response_data`, `is_user_token`, `is_response_sign`, `is_request_sign`, `response_examples`, `developer`, `api_status`, `is_page`, `sort`, `status`, `create_time`, `update_time`) VALUES
...
CREATE TABLE IF NOT EXISTS `tc_api_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `tc_api_group`
--

INSERT INTO `tc_api_group` (`id`, `name`, `sort`, `update_time`, `create_time`, `status`) VALUES
...
INSERT INTO `tc_article` (`id`, `member_id`, `name`, `category_id`, `describe`, `content`, `cover_id`, `file_id`, `img_ids`, `create_time`, `update_time`, `status`) VALUES
...
--
-- 转存表中的数据 `tc_article_category`
--

INSERT INTO `tc_article_category` (`id`, `name`, `describe`, `create_time`, `update_time`, `status`, `icon`) VALUES
...
--
-- 表的结构 `tc_attendance_people`
--

CREATE TABLE IF NOT EXISTS `tc_attendance_people` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `a_id` int(14) DEFAULT NULL COMMENT '考勤学生学号',
  `a_name` text COMMENT '考勤学生姓名',
  `a_class` varchar(255) DEFAULT NULL COMMENT '考勤学生班级',
...
CREATE TABLE IF NOT EXISTS `tc_auth_group` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='权限组表' AUTO_INCREMENT=1 ;

-- --------------------------------------------------------

--
-- 表的结构 `tc_auth_group_access`
--

CREATE TABLE IF NOT EXISTS `tc_auth_group_access` (
...
CREATE TABLE IF NOT EXISTS `tc_blogroll` (
...
INSERT INTO `tc_blogroll` (`id`, `name`, `img_id`, `url`, `describe`, `sort`, `status`, `create_time`, `update_time`) VALUES
(3, '1213', 0, '1231', '123', 0, 1, 1580540100, 1580540100);
...
INSERT INTO `tc_config` (`id`, `name`, `type`, `title`, `group`, `extra`, `describe`, `create_time`, `update_time`, `status`, `value`, `sort`) VALUES
...
CREATE TABLE IF NOT EXISTS `tc_driver` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
CREATE TABLE IF NOT EXISTS `tc_file` (
...
CREATE TABLE IF NOT EXISTS `tc_hook` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
INSERT INTO `tc_hook` (`id`, `name`, `describe`, `addon_list`, `status`, `update_time`, `create_time`) VALUES
...
INSERT INTO `tc_member` (`id`, `nickname`, `username`, `password`, `email`, `mobile`, `update_time`, `create_time`, `status`, `leader_id`, `is_share_member`, `is_inside`) VALUES
(1, 'admin', 'admin', '25b07ea3761e558429e5eb20fa951774', 'wadawda@qq.com', '18555550710', 1580530875, 1578706468, 1, 0, 0, 1);
...
CREATE TABLE IF NOT EXISTS `tc_menu` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='菜单表' AUTO_INCREMENT=211 ;

--
-- 转存表中的数据 `tc_menu`
--

INSERT INTO `tc_menu` (`id`, `name`, `pid`, `sort`, `module`, `url`, `is_hide`, `is_shortcut`, `icon`, `status`, `update_time`, `create_time`) VALUES
...
CREATE TABLE IF NOT EXISTS `tc_picture` (
