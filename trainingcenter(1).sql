...
# Date: 2020-02-03 09:52:14
# Generator: MySQL-Front 5.3  (Build 4.234)

/*!40101 SET NAMES utf8 */;

#
# Structure for table "tc_action_log"
#

DROP TABLE IF EXISTS `tc_action_log`;
CREATE TABLE `tc_action_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1318 DEFAULT CHARSET=utf8 ROW_FORMAT=FIXED COMMENT='行为日志表';

#
# Data for table "tc_action_log"
#

/*!40000 ALTER TABLE `tc_action_log` DISABLE KEYS */;
INSERT INTO `tc_action_log` VALUES (1311,1,'admin','127.0.0.1','登录','登录操作，username：admin','/admin.php/login/loginhandle.html',1,1578706483,1578706483),(1312,1,'admin','127.0.0.1','登录','登录操作，username：admin','/admin.php/login/loginhandle.html',1,1578707615,1578707615),(1313,1,'admin','127.0.0.1','登录','登录操作，username：admin','/admin.php/login/loginhandle.html',1,1580530875,1580530875),(1314,1,'admin','127.0.0.1','新增','友情链接新增，name：1213','/admin.php/blogroll/blogrolladd.html',1,1580540100,1580540100),(1315,1,'admin','127.0.0.1','登录','登录操作，username：admin','/admin.php/login/loginhandle.html',1,1580541200,1580541200),(1316,1,'admin','127.0.0.1','新增','友情链接新增，name：1231','/admin.php/blogroll/blogrolladd.html',1,1580691311,1580691311),(1317,1,'admin','127.0.0.1','登录','登录操作，username：admin','/admin.php/login/loginhandle.html',1,1580694597,1580694597);
/*!40000 ALTER TABLE `tc_action_log` ENABLE KEYS */;

#
# Structure for table "tc_addon"
#

DROP TABLE IF EXISTS `tc_addon`;
CREATE TABLE `tc_addon` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
#
# Data for table "tc_addon"
#

INSERT INTO `tc_addon` VALUES (3,'File','文件上传','文件上传插件','','Jack','1.0',1,0,0),(4,'Icon','图标选择','图标选择插件','','Bigotry','1.0',1,0,0),(5,'Editor','文本编辑器','富文本编辑器','','Bigotry','1.0',1,0,0);

#
# Structure for table "tc_api"
#
...
#
# Data for table "tc_api_group"
#

/*!40000 ALTER TABLE `tc_api_group` DISABLE KEYS */;
INSERT INTO `tc_api_group` VALUES (34,'基础接口',0,1504501195,0,1),(44,'文章接口',1,1504765319,1504765319,1),(45,'聚合接口',0,1504784149,1504784149,1);
/*!40000 ALTER TABLE `tc_api_group` ENABLE KEYS */;

#
# Structure for table "tc_article"
#
...
#
# Data for table "tc_article_category"
#

INSERT INTO `tc_article_category` VALUES (7,'基础','基础内容',1509620712,1509620712,1,'fa-street-view'),(8,'后台介绍','后台功能介绍',1509792822,1509792822,1,'fa-user');

#
# Structure for table "tc_attendance_people"
#

DROP TABLE IF EXISTS `tc_attendance_people`;
CREATE TABLE `tc_attendance_people` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `a_id` int(14) NOT NULL COMMENT '考勤学生学号',
  `a_name` text NOT NULL COMMENT '考勤学生姓名',
  `a_class` varchar(255) NOT NULL COMMENT '考勤学生班级',
  `a_number` int(11) NOT NULL COMMENT '考勤学生手机号',
  `status` tinyint(1) NOT NULL COMMENT '数据状态',
...
#
# Data for table "tc_attendance_people"
#

/*!40000 ALTER TABLE `tc_attendance_people` DISABLE KEYS */;
/*!40000 ALTER TABLE `tc_attendance_people` ENABLE KEYS */;

#
# Structure for table "tc_attendance_sign"
#

DROP TABLE IF EXISTS `tc_attendance_sign`;
CREATE TABLE `tc_attendance_sign` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `a_date` varchar(255) NOT NULL COMMENT '日期',
  `a_time` varchar(255) NOT NULL COMMENT '考勤时间',
  `a_people` varchar(255) NOT NULL COMMENT '考勤人员',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '数据状态',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
...
#
# Data for table "tc_attendance_sign"
#

/*!40000 ALTER TABLE `tc_attendance_sign` DISABLE KEYS */;
/*!40000 ALTER TABLE `tc_attendance_sign` ENABLE KEYS */;

#
# Structure for table "tc_attendance_work"
#

DROP TABLE IF EXISTS `tc_attendance_work`;
CREATE TABLE `tc_attendance_work` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `a_date` varchar(255) NOT NULL COMMENT '日期',
  `a_time` varchar(255) NOT NULL COMMENT '考勤时间',
  `a_people` varchar(255) NOT NULL COMMENT '考勤人员',
...
#
# Data for table "tc_attendance_work"
#

/*!40000 ALTER TABLE `tc_attendance_work` DISABLE KEYS */;
/*!40000 ALTER TABLE `tc_attendance_work` ENABLE KEYS */;

#
# Structure for table "tc_auth_group"
#
...
#
# Data for table "tc_auth_group"
#


#
# Structure for table "tc_auth_group_access"
#
...
#
# Data for table "tc_auth_group_access"
#


#
# Structure for table "tc_blogroll"
#

DROP TABLE IF EXISTS `tc_blogroll`;
CREATE TABLE `tc_blogroll` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
#
# Data for table "tc_blogroll"
#

/*!40000 ALTER TABLE `tc_blogroll` DISABLE KEYS */;
INSERT INTO `tc_blogroll` VALUES (3,'1213',0,'1231','123',0,1,1580540100,1580540100),(4,'1231',0,'2131','213',0,1,1580691311,1580691311);
/*!40000 ALTER TABLE `tc_blogroll` ENABLE KEYS */;

#
# Structure for table "tc_change"
#

DROP TABLE IF EXISTS `tc_change`;
CREATE TABLE `tc_change` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `i_name` text COMMENT '姓名',
  `i_department` varchar(255) DEFAULT NULL COMMENT '单位',
  `i_ip` varchar(255) DEFAULT NULL COMMENT 'IP地址',
  `i_mac` varchar(255) DEFAULT NULL COMMENT 'mac地址',
  `i_number` int(14) DEFAULT NULL COMMENT '学号/工号',
  `i_address` varchar(255) DEFAULT NULL COMMENT '地址',
  `i_type` varchar(255) DEFAULT NULL COMMENT '类型',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '数据状态',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
...
#
# Data for table "tc_change"
#

/*!40000 ALTER TABLE `tc_change` DISABLE KEYS */;
/*!40000 ALTER TABLE `tc_change` ENABLE KEYS */;

#
# Structure for table "tc_config"
#
...
#
# Data for table "tc_declare"
#

/*!40000 ALTER TABLE `tc_declare` DISABLE KEYS */;
/*!40000 ALTER TABLE `tc_declare` ENABLE KEYS */;

#
# Structure for table "tc_driver"
#

DROP TABLE IF EXISTS `tc_driver`;
CREATE TABLE `tc_driver` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
#
# Data for table "tc_driver"
#


#
# Structure for table "tc_file"
#
...
#
# Data for table "tc_file"
#


#
# Structure for table "tc_hook"
#

DROP TABLE IF EXISTS `tc_hook`;
CREATE TABLE `tc_hook` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
#
# Data for table "tc_hook"
#

INSERT INTO `tc_hook` VALUES (36,'File','文件上传钩子','File',1,0,0),(37,'Icon','图标选择钩子','Icon',1,0,0),(38,'ArticleEditor','富文本编辑器','Editor',1,0,0);

#
# Structure for table "tc_in_information"
#

DROP TABLE IF EXISTS `tc_in_information`;
CREATE TABLE `tc_in_information` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `i_number` varchar(255) NOT NULL COMMENT '入库编号',
  `i_name` char(50) NOT NULL COMMENT '名称',
  `i_numbers` varchar(255) NOT NULL COMMENT '数量',
  `i_type` varchar(255) NOT NULL COMMENT '类型',
  `i_money` varchar(255) NOT NULL COMMENT '单价',
  `i_datetime` varchar(255) NOT NULL COMMENT '入库日期',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '数据状态',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
...
#
# Data for table "tc_in_information"
#

/*!40000 ALTER TABLE `tc_in_information` DISABLE KEYS */;
/*!40000 ALTER TABLE `tc_in_information` ENABLE KEYS */;

#
# Structure for table "tc_inventory"
#

DROP TABLE IF EXISTS `tc_inventory`;
CREATE TABLE `tc_inventory` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `s_number` varchar(255) DEFAULT NULL COMMENT '编号',
  `i_number` varchar(255) DEFAULT NULL COMMENT '货品编号',
  `i_type` varchar(255) DEFAULT NULL COMMENT '货品类型',
  `i_numbers` varchar(255) DEFAULT NULL COMMENT '数量',
  `i_money` varchar(255) DEFAULT NULL COMMENT '单价',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '数据状态',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
...
#
# Data for table "tc_inventory"
#

/*!40000 ALTER TABLE `tc_inventory` DISABLE KEYS */;
/*!40000 ALTER TABLE `tc_inventory` ENABLE KEYS */;

#
# Structure for table "tc_member"
#
...
#
# Data for table "tc_member"
#

INSERT INTO `tc_member` VALUES (1,'admin','admin','3971b2175877d5cc86e125a5f337d68b','wadawda@qq.com','18555550710',1580694596,1578706468,1,0,0,1);

#
# Structure for table "tc_menu"
#
...
#
# Data for table "tc_orginal"
#

/*!40000 ALTER TABLE `tc_orginal` DISABLE KEYS */;
/*!40000 ALTER TABLE `tc_orginal` ENABLE KEYS */;

#
# Structure for table "tc_out_information"
#

DROP TABLE IF EXISTS `tc_out_information`;
CREATE TABLE `tc_out_information` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `i_number` varchar(255) NOT NULL COMMENT '货品编号',
  `o_number` varchar(255) NOT NULL COMMENT '出库编号',
  `o_name` char(50) NOT NULL COMMENT '名称',
  `o_numbers` varchar(255) NOT NULL COMMENT '数量',
  `o_money` varchar(255) NOT NULL COMMENT '单价',
  `o_datetime` varchar(255) NOT NULL COMMENT '出库日期',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '数据状态',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
...
#
# Data for table "tc_out_information"
#

/*!40000 ALTER TABLE `tc_out_information` DISABLE KEYS */;
/*!40000 ALTER TABLE `tc_out_information` ENABLE KEYS */;

#
# Structure for table "tc_out_statment"
#

DROP TABLE IF EXISTS `tc_out_statment`;
CREATE TABLE `tc_out_statment` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `i_number` varchar(255) NOT NULL COMMENT '货品编号',
  `o_name` char(50) NOT NULL COMMENT '货品名称',
  `o_type` varchar(255) NOT NULL COMMENT '类型',
  `o_numbers` varchar(255) NOT NULL COMMENT '数量',
  `o_money` varchar(255) NOT NULL COMMENT '单价',
  `all_money` varchar(255) NOT NULL COMMENT '总金额',
  `o_datetime` varchar(255) NOT NULL COMMENT '出库日期',
  `consignee` char(50) NOT NULL COMMENT '提货人',
  `administrator` char(50) NOT NULL COMMENT '管理者',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '数据状态',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
...
#
# Data for table "tc_out_statment"
#

/*!40000 ALTER TABLE `tc_out_statment` DISABLE KEYS */;
/*!40000 ALTER TABLE `tc_out_statment` ENABLE KEYS */;

#
# Structure for table "tc_picture"
#
...
#
# Data for table "tc_picture"
#


#
# Structure for table "tc_sign"
#

DROP TABLE IF EXISTS `tc_sign`;
CREATE TABLE `tc_sign` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `s_name` char(50) DEFAULT NULL COMMENT '签单人姓名',
  `s_type` varchar(255) DEFAULT NULL COMMENT '类型',
  `d_id` varchar(255) DEFAULT NULL COMMENT '申报编号',
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '数据状态',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
...
#
# Data for table "tc_sign"
#

/*!40000 ALTER TABLE `tc_sign` DISABLE KEYS */;
/*!40000 ALTER TABLE `tc_sign` ENABLE KEYS */;
